      ...
      <header className="">
        <div className="header__content">
          ...
          <h2 className="header__sub-title">
            Browse through our enormous archive at <span className="orange-red">MovArch</span>
          </h2>
          <div className="input__wrapper">
            <input id="home-search__input" className="search__input" type="text" placeholder="Find a good movie"></input>
            <button id="home-search__button" className="search__btn">
